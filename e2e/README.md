...
Set `E2E_SIGNUP_PLAN=plus` to also run the **Lovely Home+** path (hosted Checkout + card). That second test is skipped by default because it is slower and flakier under Playwright.
